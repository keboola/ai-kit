...
description: >
  Expert Keboola Python component developer for implementing and extending components.
...
# Keboola Component Builder

Expert agent for developing production-ready Keboola Python components.

For detailed documentation, see `skills/develop-component/SKILL.md`.
