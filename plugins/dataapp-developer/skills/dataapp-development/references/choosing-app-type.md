...
| MCP support today | Yes (`modify_streamlit_data_app`) | Yes (`modify_python_js_data_app`, managed-git draft→promote — client runs git) | Yes (`modify_python_js_data_app`, managed-git draft→promote — client runs git) |
